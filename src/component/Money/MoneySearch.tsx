  ...
  return (
    <EvoCard>
      <Row gutter={[24, 24]}>
        ...
        <Col span={8}>
          <Form.Item name="transactionType" label="Loại giao dịch">
            <Select placeholder="Chọn loại giao dịch" >
              ...
              <Option value="transaction">Chuyển tiền</Option>
        ...
        <Col span={8}>
          <Form.Item name="betId" label="Mã đơn cược">
            <Input placeholder="Nhập mã đơn cược" />
          </Form.Item>
        </Col>
        <Col span={8}>
          <Form.Item name="accountType" label="Loại tài khoản">
            <Select placeholder="Chọn loại tài khoản" >
              <Option value="1">Chơi thật</Option>
              <Option value="2">Chơi thử</Option>
            </Select>
          </Form.Item>
        </Col>
        <Col span={24}>
